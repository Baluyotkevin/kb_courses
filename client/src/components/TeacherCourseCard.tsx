            ...
            <CardContent className="course-card-teacher__content">
                <div className="flex flex-col">
                    ...
                    <p className="text-sm mb-2">
                        Status:{" "}
                        <span className={cn(
                            "font-semibold", course.status === "Published" ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"
                        )}
                        >
                            {course.status}
                        </span>
                    ...
                    {course.enrollments && (
                        <p className="ml-1 mt-1 inline-block text-secondary bg-secondary/10 text-sm font-sn">
